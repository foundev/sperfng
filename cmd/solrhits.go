...
const (
	SolrHitsArg = "solrhits"
)

func ExecSolrHits(args []string) error {
	solrHitsCmd := flag.NewFlagSet("solrhits", flag.ExitOnError)
	if err := solrHitsCmd.Parse(args); err != nil {
		return err
	}
